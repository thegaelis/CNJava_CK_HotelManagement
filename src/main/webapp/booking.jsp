...
<body>
	<div class="container-xxl bg-white p-0">
						...
						<div class="collapse navbar-collapse justify-content-between"
							...
							<div class="navbar-nav mr-auto py-0">
								<a class="nav-item nav-link" href="index.jsp">Home</a> <a
									...
									class="nav-item nav-link" href="rooms.jsp">Rooms</a> <a
									class="nav-item nav-link active" href="BookingController">Booking</a>
		...
		<%
			...
			//Date checkin=new SimpleDateFormat("MM/dd/yyyy").parse(request.getAttribute("checkin"));  
			...
			<form action="BookingController" method="post">
				...
				<div class="pt-4">
					...
					<div class="mt-5 text-center">
						<input type="text" value="KiemTraPhong" name="action" hidden="">
