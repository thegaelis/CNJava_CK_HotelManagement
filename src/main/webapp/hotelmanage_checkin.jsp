				...
				<div>
					<ul class="nav nav-tabs">
						<li class="nav-item"><a class="nav-link" aria-current="page"
							href="hotelmanage_manage.jsp">Manage</a></li>
					...
					<div class="container-fluid">
						<div class="card-checkin">
							<div class="card-checkin-title fs-3 fw-bold">#00001</div>
							...
							<div>
								<button class="btn btn-primary" data-bs-toggle="modal"
									data-bs-target="#modal2">View</button>
							</div>
						</div>
						<div class="card-checkin">
							<div class="card-checkin-title fs-3 fw-bold">#00001</div>
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary"
						data-bs-dismiss="modal" onclick="location.href='/Hotel_Admin/checkin1.jsp'">Duyệt</button>
				</div>
			</div>
		</div>
	</div>
