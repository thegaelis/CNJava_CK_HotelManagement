...
<body>
						...
						<div class="collapse navbar-collapse justify-content-between"
							...
							<div class="navbar-nav mr-auto py-0">
								<a class="nav-item nav-link" href="index.jsp">Home</a> <a
									...
									class="nav-item nav-link active" href="services.jsp">Services</a> <a
    ...
    <!-- Back to Top -->
    <a routerLink="/services" class="btn btn-lg btn-primary btn-lg-square back-to-top"><i class="bi bi-arrow-up"></i></a>
