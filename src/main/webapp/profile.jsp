		...
		<nav
			...
			<div class="container-fluid d-flex flex-column p-0">
				...
				<ul class="navbar-nav text-light" id="accordionSidebar">
					<li class="nav-item"><a class="nav-link" href="hotelmanage_manage.jsp"><i
							class="fas fa-table"></i><span>Hotel Manage</span></a></li>
					<li class="nav-item"><a class="nav-link" href="materialmanage_room.jsp"><i
						...
						<div class="col-lg-4">
							<div class="card mb-3">
								<div class="card-body text-center shadow">
									...
									<p class="h4 fw-bold">{{user}}</p>
									<p class="h4">{{fullName}}</p>
									<p class="h4">{{role}}</p>
								</div>
							</div>
													...
													<div class="col">
														<div class="mb-3">
															<label class="form-label" for="role_user"><strong>Role
																...
																id="role_user" value="{{role}}" disabled>
														</div>
													</div>
												</div>
												<div class="mb-3">
