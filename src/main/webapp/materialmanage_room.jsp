...
<body>
				...
				<div>
					<ul class="nav nav-tabs">
						<li class="nav-item"><a class="nav-link active"
							aria-current="page" href="materialmanage_room.jsp">Phòng</a></li>
						<li class="nav-item"><a class="nav-link"
					...
					<div class="header-room">
						<div class="wrap-search">
							<i class="fa-solid fa-magnifying-glass"></i> <input
								...
								placeholder="Nhập số phòng cần tìm" id="">
						</div>
							...
							<tbody>
								<tr>
									...
									<td><i class="fa-solid fa-pen-to-square"
										data-bs-toggle="modal" data-bs-target="#suaphong"></i></td>
					...
					<div class="addroom-body">
						<div class="addroom-wrap">
							<i class="fa-solid fa-house"></i> <input class="addroom-input"
								type="number" name="" id="" placeholder="Nhập số phòng">
						</div>
						<div class="addroom-wrap">
							<i class="fa-solid fa-power-off"></i> <select name="" id=""
								class="addroom-input" style="color: #7d7d7d;">
								<option value="">Tình trạng</option>
								<option value="">Sẵn sàng</option>
								<option value=" ">Không sẵn sàng</option>
							</select>
						</div>
						<div class="addroom-wrap">
							<i class="fa-solid fa-layer-group"></i> <select name="" id=""
								class="addroom-input" style="color: #7d7d7d;">
	...
	<!-- Modal sửa phòng -->
	<div class="modal fade" id="suaphong" data-bs-backdrop="static"
		data-bs-keyboard="false" tabindex="-1"
		aria-labelledby="staticBackdropLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
