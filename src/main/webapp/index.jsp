		...
		<!-- <div class="container-xxl testimonial mt-5 py-5 bg-dark wow zoomIn"
			...
			<div class="container">
				<div class="owl-carousel testimonial-carousel py-5">
					<div
						class="testimonial-item position-relative bg-white rounded overflow-hidden mySlides">
						<p>Nhân viên nhiệt tình, thân thiện, phòng sạch sẽ, đầy đủ
							tiện nghi thật sự tôi đã có trải nghiệm tuyệt vời tại đây🥰</p>
						<div class="d-flex align-items-center">
							<img class="img-fluid flex-shrink-0 rounded"
								src="assets/img/testimonial-1.jpg"
								style="width: 45px; height: 45px;">
							<div class="ps-3">
								<h6 class="fw-bold mb-1">Thu T. V.</h6>
					...
					<div
						class="testimonial-item position-relative bg-white rounded overflow-hidden mySlides s">
						<p>Tôi nghĩ khách sạn chỉ ở mức trung bình. Vị trí rất tuyệt
							vời và nó rất gần với các đường phố lớn. Phòng của tôi hơi nhỏ
							cho 2 người, không gian thoáng mát. Chất lượng vẫn tốt so với số
							tiền bỏ ra.</p>
						<div class="d-flex align-items-center">
							<img class="img-fluid flex-shrink-0 rounded"
								...
								style="width: 45px; height: 45px;">
							<div class="ps-3">
								<h6 class="fw-bold mb-1">Ho Hoai N.</h6>
								<small>Khách hàng</small>
							</div>
						</div>
						<i
					...
					<div
						class="testimonial-item position-relative bg-white rounded overflow-hidden mySlides s">
						<p>Khách sạn có khuồn viên rất rộng dưới rừng thông, cảnh quan
							đẹp mắt, yên tĩnh. Hồ tuyền lâm kế bên thật sự rất đẹp. Phòng ốc
							sạch sẽ, giá cả trên traveloka rất tốt so với các app đặt phòng
							khác. Mình rất thích và sẽ quay lại</p>
						<div class="d-flex align-items-center">
							<img class="img-fluid flex-shrink-0 rounded"
								src="assets/img/testimonial-3.jpg"
								style="width: 45px; height: 45px;">
							<div class="ps-3">
								<h6 class="fw-bold mb-1">Viet P. H. A.</h6>
								<small>Khách hàng</small>
							</div>
						</div>
						<i
				...
				<div class="button-tes">
					<button class="w3-button w3-display-left w3-black btn-left"
						onclick="plusDivs(-1)">&#10094;</button>
					<button class="w3-button w3-display-right w3-black btn-right"
						onclick="plusDivs(1)">&#10095;</button>
				</div>
			</div>
		</div> -->
			...
			<div class="container">
				<div class="text-center wow fadeInUp" data-wow-delay="0.1s">
					<h6 class="section-title text-center text-primary text-uppercase">Our
						Team</h6>
					<h1 class="mb-5">
						Explore Our <span class="text-primary text-uppercase">Staffs</span>
					</h1>
				</div>
				<div class="row g-4">
